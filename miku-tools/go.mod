...
require (
	...
	github.com/qbox/mikud-live v1.5.1-0.20260209101717-2889c448aa51
	github.com/qbox/pili v1.0.37
	github.com/qiniu/x v1.15.1
	github.com/redis/go-redis/v9 v9.11.0
	github.com/rs/zerolog v1.32.0
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.721
