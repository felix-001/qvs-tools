...
type HuyaTranscodeRate struct {
}

func (h *HuyaTranscodeRate) Generate(req qos.QOSRequest) any {
...
func (h *HuyaTranscodeRate) ID() string {
	return "chart_HyTranscodeRateTrend"
}

func (h *HuyaTranscodeRate) ChartInfo() qos.ChartInfo {
