...
const StreamUrl = "http://localhost:1985/api/v1/gb28181?action=talk&id=31010403001370002272&is_new=true&base64_pcm="
const InviteUrl = "http://localhost:7279/api/v1/gb28181?action=sip_invite&chid=31010403001370002272&id=31010403001370002272&ip=100.100.81.214&rtp_port=9001&rtp_proto=udp&is_talk=true&ssrc="
